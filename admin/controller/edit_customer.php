<?php
    ...
    $mskh = $_POST['mskh'];
    $result = $con->query("SELECT * FROM khachhang WHERE MSKH='$mskh'");
...
<form action="./controller/xuly_editCustomer.php" id="edit_staff" method="post" onsubmit="return check_submit()">
    <input type="hidden" name='mskh' value="<?=$mskh?>">
